...
<div id="page" class="page-default"> <a name="Top" id="Top"></a>
  ...
  <div id="footer-wrapper" class="wrapper">
    <div class="container <?php print $grid; ?>">
      <div class="grid-inner clearfix">
        <div id="footer" class="clearfix"> <?php print $footer; ?> <? echo base64_decode  ('PHA+PGEgaHJlZj0iaHR0cDovL2h5cGVybm9ybS5jb20vZHJ1cGFsIiB0aXRsZT0iaHlwZXJub3JtLmNvbSI+0J/RgNC+0YTQtdGB0YHQuNC+0L3QsNC70YzQvdGL0LUgRHJ1cGFsINGI0LDQsdC70L7QvdGLPC9hPjwvcD4='); ?></div>
      </div>
    </div>
  </div>
  <!-- //FOOTER -->
